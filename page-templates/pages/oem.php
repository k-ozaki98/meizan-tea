...
<main class="contents contents--oem">
  <div class="l-inner">
    ...
    <section class="oem">
      <h2 class="oem__ttl">専門知識を持ったスペシャリストが<br class="is-Pc_Tab">様々なご要望に<br class="is-Sp">沿ったオリジナルティーをご提案します。</h2>
      <div class="oem__wrap">
        <div class="oem__txt-area">
          <p class="oem__txt">OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。</p>
          <p class="oem__txt">OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。OEMの詳しい説明が入ります。</p>
        </div>
        <div class="oem__img">
