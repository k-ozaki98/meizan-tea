    ...
    <section class="about">
      ...
      <ul class="about__list">
        ...
        <li>
          ...
          <p class="about__list-body">私たちの仕事は、茶葉を輸入して卸すだけではありません。お茶は誰が淹れても同じ味になるわけではなく、淹れる温度や淹れ方で、繊細に変化する自然物です。時に一人で、時に仲間と、リラックスしたり、楽しんだり……。私たちは、お茶が供される様々なシーンを想像し、商品としての価値を創造しています。</p>
        </li>
        <li>
          <div class="about__list-top">
