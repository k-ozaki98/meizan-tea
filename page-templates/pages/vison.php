...
<main class="contents contents--vison">
  <div class="l-inner">
    ...
    <div class="vison-mv">
      <div class="vison-mv__img">
        <picture>
          ...
          <img src="<?php echo get_template_directory_uri() ?>/assets/images/about/vison-img.png" alt="ビジョン　イメージ背景画像">
        </picture>
      </div>
    ...
    <section class="vison">
      ...
      <p class="vison__txt">まずはお茶を、一杯どうぞ。</p>

      <div class="vison__name-wrap">
        <div class="vison__name-img">
          <img src="<?php echo get_template_directory_uri() ?>/assets/images/about/vison-icon.png" alt="代表取締役　砂押 悠子　写真" width="140" height="30">
        </div>
        <div class="vison__name-area">
          <p class="vison__name">代表取締役</p>
          <div class="vison__img">
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/about/vison-name.png" alt="砂押 悠子" width="129" height="36">
          </div>
        </div>
      </div>
    </section>
